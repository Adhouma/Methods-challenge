...
public class Main {
	...
	public static void main(String[] args) {
		...
		displayHighScorePosition("Abdeladhim", highScorePosition);
		
		highScorePosition = calculateHighScorePosition(900);
		displayHighScorePosition("Sabrine", highScorePosition);
		
		highScorePosition = calculateHighScorePosition(400);
		displayHighScorePosition("Raoudha", highScorePosition);
		
		highScorePosition = calculateHighScorePosition(50);
		displayHighScorePosition("Abdelmomen", highScorePosition);
	}
